...
def main(_):
  ...
  elif kwargs["algo"] == "cosine_similarity":
    reward_type = "cosine_similarity"
  elif kwargs["algo"] == "temporal_difference":
    reward_type = "temporal_difference"
  elif kwargs["algo"] == "collision_penalty":
    reward_type = "collision_penalty"
  elif kwargs["algo"] == "path_smoothness":
    reward_type = "path_smoothness"
  else:
